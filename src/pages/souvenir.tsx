...
const Souvenir: FC<Props> = ({ moon, name, children }) => {
    ...
    return (
        <BlankPage bg="plain-space.gif" fadeInScene>
            ...
            <a href="https://instagram.com/itsrainingallovertheuniverse" target="_blank" rel="noopener noreferrer" className="bg-black rounded-full px-4 py-1 text-lg cursor-pointer flex gap-1 items-center absolute z-0 bottom-4">
                More information
